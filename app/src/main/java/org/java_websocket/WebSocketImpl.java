...
public class WebSocketImpl implements WebSocket {
	...
	public void decode( ByteBuffer socketBuffer ) {
		...
		if( DEBUG )
			System.out.println( "WebSocketImpl():decode()....process(" + socketBuffer.remaining() + "): {" + ( socketBuffer.remaining() > 1000 ? "too big to display" : new String( socketBuffer.array(), socketBuffer.position(), socketBuffer.remaining() ) ) + "}" );
		...
		System.out.println("####WebSocketClient(): decode().....................FINISHED.");
	...
	private void decodeFrames( ByteBuffer socketBuffer ) {
		...
		try {
			...
			for( Framedata f : frames ) {
				if( DEBUG )
					System.out.println( "WebSocketImpl():decodeFrame()....matched frame: " + f );
				
				Opcode curop = f.getOpcode();
				boolean fin = f.isFin();

				if( curop == Opcode.CLOSING ) {
					System.out.println( "WebSocketImpl():decodeFrame()....Opcode.CLOSING");
					...
					System.out.println( "WebSocketImpl():decodeFrame()....Opcode.PING");
					
					wsl.onWebsocketPing( this, f );
					continue;
				} else if( curop == Opcode.PONG ) {
					System.out.println( "WebSocketImpl():decodeFrame()....Opcode.PONG");
					
					wsl.onWebsocketPong( this, f );
					continue;
				} else if( !fin || curop == Opcode.CONTINUOUS ) {
					System.out.println( "WebSocketImpl():decodeFrame()....Opcode.CONTINUOUS");
					...
					System.out.println( "WebSocketImpl():decodeFrame()....current_continuous_frame_opcode != null");
					
					throw new InvalidDataException( CloseFrame.PROTOCOL_ERROR, "Continuous frame sequence not completed." );
				} else if( curop == Opcode.TEXT ) {
					System.out.println( "WebSocketImpl():decodeFrame()....Opcode.TEXT");
					...
					System.out.println( "WebSocketImpl():decodeFrame()....Opcode.BINARY");
					...
					System.out.println( "WebSocketImpl():decodeFrame()....non control or continious frame expected");
	...
	public void sendFrame( Framedata framedata ) {
		if( DEBUG )
			System.out.println( "####WebSocketImpl():sendFrame:send frame: " + framedata );
	...
	private void write( ByteBuffer buf ) {
		if( DEBUG )
			System.out.println( "### WebSocketClient() write(" + buf.remaining() + "): {" + ( buf.remaining() > 1000 ? "too big to display" : new String( buf.array() ) ) + "}" );
